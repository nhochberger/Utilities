...
public class PictureScaler {
     ...
     */
    public BufferedImage getFasterScaledInstance(final BufferedImage img,
    ...
    public BufferedImage getFasterScaledInstance(final Image img,
            final int targetWidth, final int targetHeight, final Object hint,
            final boolean progressiveBilinear) {
        ...
        return getFasterScaledInstance(image, targetWidth, targetHeight, hint,
                progressiveBilinear);
    }
    ...
    public BufferedImage scale(final Image img, final int targetWidth,
            final int targetHeight) {
        return getFasterScaledInstance(img, targetWidth, targetHeight,
                RenderingHints.VALUE_INTERPOLATION_BICUBIC, true);
    }

    public BufferedImage scale(final BufferedImage img, final int targetWidth,
            final int targetHeight) {
        return getFasterScaledInstance(img, targetWidth, targetHeight,
                RenderingHints.VALUE_INTERPOLATION_BICUBIC, true);
    }
